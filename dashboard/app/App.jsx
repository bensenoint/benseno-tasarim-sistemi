...
function App({ currentUser, onLogout }) {
  ...
  else if (tab === "brand")    Screen = <BrandScreen    data={liveData} onOpenBrief={onOpenBrief} onOpenCompleted={onOpenCompleted} initialSel={brandSel} currentUser={currentUser}/>;
