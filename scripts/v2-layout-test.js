...
t('geçerli korunur', L.bnsV2Validate([{type:'capacity',x:0,y:0,w:4,h:2}]).length, 1);
t('negatif boyut → varsayılan', L.bnsV2Validate([{type:'capacity',x:0,y:-1,w:4,h:2}]).length, 5);
t('serialize tip+konum', L.bnsV2Serialize([{id:'capacity',type:'capacity',x:1,y:2,w:3,h:4}]), [{id:'capacity',type:'capacity',x:1,y:2,w:3,h:4}]);
