...
function GalleryTile({ c, idx }) {
  ...
  // Tıklama: teslim varsa dosyayı aç (resim açılır, dosya iner); yoksa thread'i aç.
  const open = () => {
    if (heroSrc) window.open(heroSrc, "_blank");
    else if (slackUrl !== "#") window.open(slackUrl, "_blank");
  };
